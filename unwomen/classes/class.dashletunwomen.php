...
class dashletunwomen implements DashletInterface
{
  const version = '1.0';
  ...
  public function render($width = 300)
  {
    ...
    ///////
    $dashletView = new dashletunwomenView($arrayUser, $this->note);
...
class dashletunwomenView extends Smarty
{
  private $smarty;
  ...
  public function __construct($u, $n)
  {
    ...
    $this->smarty->templateFile = PATH_PLUGINS . "unwomen" . PATH_SEP . "views" . PATH_SEP . "dashletunwomen.html";
  }
