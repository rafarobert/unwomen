...
foreach ($G_TMP_MENU->Id as $index => $value) {
  if ($index == 3) { //Option CASES_INBOX
    $tmpId[$index + $k]      = "ID_UNWOMEN_MNUCASE_01";
    $tmpTypes[$index + $k]   = "plugins";
    $tmpEnabled[$index + $k] = 1;
    $tmpOptions[$index + $k] = "../unwomen/unwomenApplication"; //link
    $tmpLabels[$index + $k]  = "unwomen application1";
    $tmpJS[$index + $k]      = null;
...
$tmpId[$i]      = "ID_UNWOMEN_MNUCASE_02";
$tmpTypes[$i]   = "blockHeader";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = null; //link
$tmpLabels[$i]  = "unwomen application2";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
...
$tmpId[$i]      = "ID_UNWOMEN_MNUCASE_03";
$tmpTypes[$i]   = "plugins";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = "../unwomen/unwomenApplication2"; //link
$tmpLabels[$i]  = "unwomen application2";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
...
$tmpId[$i]      = "ID_UNWOMEN_MNUCASE_04";
$tmpTypes[$i]   = "blockHeaderNoChild";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = "../unwomen/unwomenApplication3"; //link
$tmpLabels[$i]  = "unwomen application3";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
