Ext.namespace("stepunwomen");

stepunwomen.application = {
  init:function(){
    storeApplicationProcess = function () {
      ...
      Ext.Ajax.request({
        url: "../unwomen/stepunwomenApplicationAjax",
        method: "POST",
...
Ext.onReady(stepunwomen.application.init, stepunwomen.application);