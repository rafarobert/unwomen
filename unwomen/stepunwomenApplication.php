...
try {
  ...
  $oHeadPublisher->addContent("unwomen/stepunwomenApplication"); //Adding a html file .html.
  $oHeadPublisher->addExtJsScript("unwomen/stepunwomenApplication", false); //Adding a javascript file .js
